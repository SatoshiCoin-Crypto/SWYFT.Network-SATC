...
RESOURCES += src/qt/satc.qrc src/qt/satc_locale.qrc

TRANSLATIONS += src/qt/locale/satc_bg.ts \
                src/qt/locale/satc_de.ts \
                src/qt/locale/satc_en.ts \
                src/qt/locale/satc_es.ts \
                src/qt/locale/satc_fi.ts \
                src/qt/locale/satc_fr.ts \
                src/qt/locale/satc_it.ts \
                src/qt/locale/satc_ja.ts \
                src/qt/locale/satc_pl.ts \
                src/qt/locale/satc_pt.ts \
                src/qt/locale/satc_ru.ts \
                src/qt/locale/satc_sk.ts \
                src/qt/locale/satc_sv.ts \
                src/qt/locale/satc_vi.ts \
                src/qt/locale/satc_zh_CN.ts \
                src/qt/locale/satc_zh_TW.ts
