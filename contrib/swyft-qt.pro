...
RESOURCES += src/qt/swyft.qrc src/qt/swyft_locale.qrc

TRANSLATIONS += src/qt/locale/swyft_bg.ts \
                src/qt/locale/swyft_de.ts \
                src/qt/locale/swyft_en.ts \
                src/qt/locale/swyft_es.ts \
                src/qt/locale/swyft_fi.ts \
                src/qt/locale/swyft_fr.ts \
                src/qt/locale/swyft_it.ts \
                src/qt/locale/swyft_ja.ts \
                src/qt/locale/swyft_pl.ts \
                src/qt/locale/swyft_pt.ts \
                src/qt/locale/swyft_ru.ts \
                src/qt/locale/swyft_sk.ts \
                src/qt/locale/swyft_sv.ts \
                src/qt/locale/swyft_vi.ts \
                src/qt/locale/swyft_zh_CN.ts \
                src/qt/locale/swyft_zh_TW.ts
