...
#   c) node1 mines 32 blocks, so now node 0 has 60001satc, node 1 has 4250satc, node2 has none.
#   d) node0 sends 601 satc to node2, in two transactions (301 satc, then 300 satc).
