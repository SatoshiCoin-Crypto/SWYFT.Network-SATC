...
#   c) node1 mines 32 blocks, so now node 0 has 60001swyft, node 1 has 4250swyft, node2 has none.
#   d) node0 sends 601 swyft to node2, in two transactions (301 swyft, then 300 swyft).
