...
In order to support loading of multiple wallets in swyft-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is swyft.cpp.
...
Changes to swyft.cpp
----------------------
swyft.cpp is the entry point into swyft-qt, and as such, will require some minor modifications to provide hooks for
