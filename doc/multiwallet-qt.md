...
In order to support loading of multiple wallets in satc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is satc.cpp.
...
Changes to satc.cpp
----------------------
satc.cpp is the entry point into satc-qt, and as such, will require some minor modifications to provide hooks for
