Contributing to SWYFT.Network
============================

The SWYFT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SWYFT.Network project, and is not to be
confused with overall SWYFT.Network Protocol consensus changes.

Whether a pull request is merged into SWYFT.Network rests with the project merge
...
Patches that change SWYFT.Network consensus rules are considerably more involved than
...
Where a patch set proposes to change the SWYFT.Network consensus, it must have been
...
The project leader is the release manager for each SWYFT.Network release.
