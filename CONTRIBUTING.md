Contributing to SATC Core
============================

The SATC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SATC Core project, and is not to be
confused with overall SATC Network Protocol consensus changes.

Whether a pull request is merged into SATC Core rests with the project merge
...
Patches that change SATC consensus rules are considerably more involved than
...
Where a patch set proposes to change the SATC consensus, it must have been
...
The project leader is the release manager for each SATC Core release.
