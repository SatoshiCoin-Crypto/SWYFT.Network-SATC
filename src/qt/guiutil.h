...
/** Utility functions used by the SWYFT.Network Wallet Qt UI.
 */
namespace GUIUtil
{
...
// Render SWYFT.Network addresses in monospace font
...
// Parse "swyft:" URI into recipient object, return true on successful parsing
