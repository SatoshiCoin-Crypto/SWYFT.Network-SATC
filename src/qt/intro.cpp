...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SWYFT.Network Wallet"),
     ...
     * override -datadir in the swyft.conf file in the default data directory
     * (to be consistent with swyftd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
