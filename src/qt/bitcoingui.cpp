...
QFontDatabase::addApplicationFont(":/fonts/satc_font");

QString windowTitle = tr("SatoshiCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SATC: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SatoshiCoin Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about SatoshiCoin Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SatoshiCoin Wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SATC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SATC addresses"));
    ...
    openAction->setStatusTip(tr("Open a SATC: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SatoshiCoin Wallet help message to get a list with possible SATC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SatoshiCoin Wallet client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SatoshiCoin Wallet"); // default title
    ...
    // Append title to "SatoshiCoin Wallet - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
