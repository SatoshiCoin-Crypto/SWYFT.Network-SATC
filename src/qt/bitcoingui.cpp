...
QFontDatabase::addApplicationFont(":/fonts/swyft_font");

QString windowTitle = tr("SWYFT.Network Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SWYFT.Network address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SWYFT.Network: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SWYFT.Network Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about SWYFT.Network Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SWYFT.Network Wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SWYFT.Network addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SWYFT.Network addresses"));
    ...
    openAction->setStatusTip(tr("Open a SWYFT.Network: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SWYFT.Network Wallet help message to get a list with possible SWYFT.Network command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SWYFT.Network Wallet client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SWYFT.Network network", "", count));
}
...
{
    QString strTitle = tr("SWYFT.Network Wallet"); // default title
    ...
    // Append title to "SWYFT.Network Wallet - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
