...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SWYFT.Network Core swyft-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  swyft-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SWYFT.Network transaction") + "\n" +
                               "  swyft-tx [options] -create [commands]   " + _("Create hex-encoded SWYFT.Network transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SWYFT.Network transaction
