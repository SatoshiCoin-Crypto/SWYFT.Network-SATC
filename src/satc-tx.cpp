...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SatoshiCoin Core satc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  satc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SATC transaction") + "\n" +
                               "  satc-tx [options] -create [commands]   " + _("Create hex-encoded SATC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SATC transaction
