...
#if defined(NDEBUG)
#error "SATC cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usatc) are considered zero fee (for relaying and mining)
