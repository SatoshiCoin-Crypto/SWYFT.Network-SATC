...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("00000f921c0724d441645f9e5a248321f7b9a73a9177b5eefaedca214e75755b"))
                              ...
                              (177000, uint256("2651c1ca6414b0dec16d1c5fd4d8027b5a38073b37d166d47e1fbcb7c980689e"));
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("000002aeb80ed2b88e4a7128ed147676029e3f00feb2e1d38b0eab59bb1d0d0a"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("00000d2544bc451ccc97c89a45f08fda5124a019ea1d0125ad18375ccbfb5a6e"));
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "RT.com Dec 06, 2018 UK has provided guarantees Assange wont be extradited to face death penalty – Ecuadors president";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1544119200;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 877148;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("00000f921c0724d441645f9e5a248321f7b9a73a9177b5eefaedca214e75755b"));
        assert(genesis.hashMerkleRoot == uint256("cb3ebaca3c31a3b60bc2deaeda60fc0bfa70116759d9fbb1ba9a03d358c6bf02"));
        ...
        strSporkKey = "04BA3EBD546632D73B309550D92D69F4D65489C7437A6815C272D2E6A59C3A83C7C2FCB4F2D9BDCC026DB3CE42D017DA746A650C5235679E11011F92CCA8B1D5E0";
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1544119300;
        genesis.nNonce = 1179338;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("000002aeb80ed2b88e4a7128ed147676029e3f00feb2e1d38b0eab59bb1d0d0a"));
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 1188220;

        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51476;

        assert(hashGenesisBlock == uint256("00000d2544bc451ccc97c89a45f08fda5124a019ea1d0125ad18375ccbfb5a6e"));
